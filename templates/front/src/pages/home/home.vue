...
<div class="home-preview" :style='{"margin":"0px auto","flexWrap":"wrap","flexDirection":"row","background":"#fff","display":"flex","width":"100%","justifyContent":"center"}'>
	...
	<div id="animate_newsnews" class="news animate__animated" :style='{"padding":"0","margin":"40px auto 40px","background":"url(),#fff","flex":"1","width":"100%","position":"relative","order":"5"}'>
		...
		<div class="title" :style='{"width":"76%","padding":"36px 0 0","margin":"0px auto","textAlign":"left","background":"url() no-repeat left top / auto 42px","height":"100px"}'>
			<span :style='{"color":"#000","fontSize":"32px","fontWeight":"600"}'>公告信息</span>
		</div>
...
<!-- 商品推荐 -->
<div id="animate_recommendshebeixinxi" class="recommend animate__animated" :style='{"padding":"60px 0 60px","margin":"40px auto 20px","borderColor":"#ddd","background":"#f1f1f1","borderWidth":"0px 0","width":"100%","position":"relative","borderStyle":"solid","order":"2"}'>
    ...
    <div class="title" :style='{"width":"76%","padding":"45px 0 0","margin":"0px auto","textAlign":"left","background":"url() no-repeat left top / auto 42px","height":"120px"}'>
		<span :style='{"padding":"0","fontSize":"32px","color":"#000","fontWeight":"600","display":"block"}'>设备信息推荐</span>
	</div>
		...
		<div v-if="shebeixinxiRecommend.length" class="list list16 index-pv1" :style='{"padding":"0 12%","margin":"20px 0 0","color":"#999","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","justifyContent":"space-between","height":"auto"}'>
		  <div v-for="item,index in shebeixinxiRecommend" :key="index"  @click="toDetail('shebeixinxiDetail', item)" class="list-item animation-box">
		    <div :style='{"border":"0px solid red","width":"100%","padding":"0px","overflow":"hidden","height":"320px"}' class="img-box">
				<img class="image" :style='{"width":"100%","objectFit":"cover","display":"block","height":"100%"}' v-if="preHttp(item.shebeifengmian)" :src="item.shebeifengmian.split(',')[0]" alt="" />
				<img class="image" :style='{"width":"100%","objectFit":"cover","display":"block","height":"100%"}' v-else :src="baseUrl + (item.shebeifengmian?item.shebeifengmian.split(',')[0]:'')" alt="" />
			</div>
		    <div :style='{"width":"100%","padding":"0","overflow":"hidden","display":"flex","height":"auto"}' class="item-info">
		      ...
		      <div class="desc" v-html="item.shebeixiangqing"></div>
		    </div>
		  </div>
		</div>
	
	<div @click="moreBtn('shebeixinxi')" :style='{"border":"0px solid #fff","cursor":"pointer","padding":"0 20px 0 0","margin":"90px -12px 0 0","textAlign":"right","display":"block","right":"12%","top":"0","background":"url(http://codegen.caihongy.cn/20231010/b345185c76ac4a77bf4cd6f6171a72ed.png) no-repeat center top / 100% 100%","width":"240px","lineHeight":"73px","position":"absolute","height":"80px"}'>
		<span :style='{"color":"#333","fontSize":"14px"}'>查看更多</span>
		<i :style='{"color":"#333","fontSize":"16px","display":"none"}' class="icon iconfont icon-jiantou09"></i>
	</div>
    ...
    methods: {
		...
		handleScroll() {
			let arr = [
				...
				{id:'animate_recommendshebeixinxi',css:'animate__'},
      ...
      getSystemIntroduction() {
		...
		getList() {
			let autoSortUrl = "";
			let data = {}
          autoSortUrl = "shebeixinxi/autoSort";
          if(localStorage.getItem('frontToken')) {
              autoSortUrl = "shebeixinxi/autoSort2";
          }
			data = {
				page: 1,
				limit: 8,
			...
			this.$http.get(autoSortUrl, {params: data}).then(res => {
				if (res.data.code == 0) {
					this.shebeixinxiRecommend = res.data.data.list;
