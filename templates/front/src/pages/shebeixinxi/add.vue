...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#edeff1"}'>
    <el-form
      ...
      label-width="150px"
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="设备编号" prop="shebeibianhao">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="设备类型" prop="shebeileixing">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="设备封面" v-if="type!='cross' || (type=='cross' && !ro.shebeifengmian)" prop="shebeifengmian">
            <file-upload
            tip="点击上传设备封面"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' class="upload" v-else label="设备封面" prop="shebeifengmian">
                ...
                <img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.shebeifengmian.split(',')" :src="baseUrl+item" width="100" height="100">
            </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="设备规格" prop="shebeiguige">
            <el-input v-model="ruleForm.shebeiguige" 
                placeholder="设备规格" clearable :disabled=" false  ||ro.shebeiguige"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="设备详情" prop="shebeixiangqing">
            <editor 
  ...
  export default {
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='shebeifengmian'){
              this.ruleForm.shebeifengmian = obj[o].split(",")[0];
    ...
    // 多级联动参数
      ...
      shebeifengmianUploadChange(fileUrls) {
          this.ruleForm.shebeifengmian = fileUrls.replace(new RegExp(this.$config.baseUrl,"g"),"");;
      },
    }
  };
</script>
